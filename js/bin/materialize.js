  ...
  jQuery.fn.collapsible = function (methodOrOptions) {
    ...
    if (Collapsible.prototype[methodOrOptions]) {
      ...
      if (methodOrOptions.slice(0, 3) === 'get') {
        var instance = this.first()[0].M_Collapsible;
        return instance[methodOrOptions].apply(instance, params);

        // Void methods
      } else {
        return this.each(function () {
          var instance = this.M_Collapsible;
  ...
  var Dropdown = function () {
    ...
    _createClass(Dropdown, [{
      ...
      value: function _handleTriggerKeydown(e) {
        ...
        if ((e.which === Materialize.keys.ARROW_DOWN || e.which === Materialize.keys.ENTER) && !this.isOpen) {
          e.preventDefault();
          this.open();
        }
      }
      ...
      value: function _handleDropdownKeydown(e) {
        ...
        } else if ((e.which === Materialize.keys.ARROW_DOWN || e.which === Materialize.keys.ARROW_UP) && this.isOpen) {
          e.preventDefault();
          var direction = e.which === Materialize.keys.ARROW_DOWN ? 1 : -1;
      ...
      value: function _getDropdownPosition() {
        ...
        var alignments = Materialize.checkPossibleAlignments(this.el, closestOverflowParent, dropdownBounds, this.options.coverTrigger ? 0 : triggerBRect.height);
  ...
  var Modal = function () {
    ...
    _createClass(Modal, [{
      ...
      value: function _handleTriggerClick(e) {
        ...
        if ($trigger.length) {
          var modalId = Materialize.getIdFromTrigger($trigger[0]);
  ...
  var Parallax = function () {
    ...
    _createClass(Parallax, [{
      ...
      value: function _updateParallax() {
        ...
        var scrollTop = Materialize.getDocumentScrollTop();
...
;(function ($, Vel) {
    ...
    _createClass(Tabs, [{
          ...
          if (this._tabsCarousel) {
            this._tabsCarousel.set(this.index, function () {
              if (typeof _this15.options.onShow === "function") {
                _this15.options.onShow.call(_this15, _this15.$content);
              }
            });
          }
        } else {
      ...
      value: function _setupSwipeableTabs() {
        ...
        this.$tabLinks.each(function (link) {
          var $currContent = $(Materialize.escapeHash(link.hash));
  ...
  jQuery.fn.tabs = function (methodOrOptions) {
    ...
    if (Tabs.prototype[methodOrOptions]) {
      ...
      // Getter methods
      if (methodOrOptions.slice(0, 3) === 'get') {
        var instance = this.first()[0].M_Tabs;
        return instance[methodOrOptions].apply(instance, params);

        // Void methods
      } else {
        return this.each(function () {
          var instance = this.M_Tabs;
          instance[methodOrOptions].apply(instance, params);
        });
      }
  ...
  var Tooltip = function () {
    ...
    _createClass(Tooltip, [{
      ...
      value: function _repositionWithinScreen(x, y, width, height) {
        var scrollLeft = Materialize.getDocumentScrollLeft();
        var scrollTop = Materialize.getDocumentScrollTop();
        ...
        var edges = Materialize.checkWithinContainer(document.body, bounding, offset);
    ...
    _createClass(Sidenav, [{
      ...
      value: function _handleTriggerClick(e) {
        ...
        if (e.target && $trigger.length) {
          var sidenavId = Materialize.getIdFromTrigger($trigger[0]);
...
;(function ($, Vel) {
  ...
  var ScrollSpy = function () {
    ...
    _createClass(ScrollSpy, [{
      ...
      key: '_setupEventHandlers',
      value: function _setupEventHandlers() {
        var throttledResize = Materialize.throttle(this._handleWindowScroll, 200);
      ...
      value: function _handleWindowScroll() {
        ...
        // viewport rectangle
        var top = Materialize.getDocumentScrollTop(),
  ...
  jQuery.fn.scrollSpy = function (methodOrOptions) {
    ...
    if (ScrollSpy.prototype[methodOrOptions]) {
      ...
      // Getter methods
      if (methodOrOptions.slice(0, 3) === 'get') {
        var instance = this.first()[0].M_ScrollSpy;
        return instance[methodOrOptions].apply(instance, params);

        // Void methods
      } else {
        return this.each(function () {
          var instance = this.M_ScrollSpy;
          instance[methodOrOptions].apply(instance, params);
        });
      }
...
;(function ($) {
  ...
  jQuery.fn.autocomplete = function (methodOrOptions) {
    ...
    if (Autocomplete.prototype[methodOrOptions]) {
      ...
      // Getter methods
      if (methodOrOptions.slice(0, 3) === 'get') {
        var instance = this.first()[0].M_Autocomplete;
        return instance[methodOrOptions].apply(instance, params);

        // Void methods
      } else {
        return this.each(function () {
          var instance = this.M_Autocomplete;
          instance[methodOrOptions].apply(instance, params);
        });
      }
...
;(function ($, Vel) {
  ...
  jQuery.fn.chips = function (methodOrOptions) {
    ...
    if (Chips.prototype[methodOrOptions]) {
      ...
      // Getter methods
      if (methodOrOptions.slice(0, 3) === 'get') {
        var instance = this.first()[0].M_Chips;
        return instance[methodOrOptions].apply(instance, params);

        // Void methods
      } else {
        return this.each(function () {
          var instance = this.M_Chips;
          instance[methodOrOptions].apply(instance, params);
        });
      }
  ...
  var Pushpin = function () {
    ...
    _createClass(Pushpin, [{
      ...
      value: function _updatePosition() {
        var scrolled = Materialize.getDocumentScrollTop() + this.options.offset;
...
;(function ($, Vel) {
  ...
  var Timepicker = function () {
    ...
    _createClass(Timepicker, [{
      ...
      value: function _pickerSetup() {
        $('<button type="button" class="btn-flat timepicker-clear waves-effect" tabindex="' + (this.options.twelvehour ? '3' : '1') + '">' + this.options.cleartext + '</button>').appendTo(this.footer).on('click', this.clear.bind(this));
        $('<button type="button" class="btn-flat timepicker-close waves-effect" tabindex="' + (this.options.twelvehour ? '3' : '1') + '">' + this.options.canceltext + '</button>').appendTo(this.footer).on('click', this.close.bind(this));
        $('<button type="button" class="btn-flat timepicker-close waves-effect" tabindex="' + (this.options.twelvehour ? '3' : '1') + '">' + this.options.donetext + '</button>').appendTo(this.footer).on('click', this.done.bind(this));
      }
    }, {
      key: '_clockSetup',
  ...
  Timepicker._template = ['<div class= "modal timepicker-modal">', '<div class="modal-content timepicker-container">', '<div class="timepicker-digital-display">', '<div class="timepicker-text-container">', '<div class="timepicker-display-column">', '<span class="timepicker-span-hours text-primary"></span>', ':', '<span class="timepicker-span-minutes"></span>', '</div>', '<div class="timepicker-display-column timepicker-display-am-pm">', '<div class="timepicker-span-am-pm"></div>', '</div>', '</div>', '</div>', '<div class="timepicker-analog-display">', '<div class="timepicker-plate">', '<div class="timepicker-canvas"></div>', '<div class="timepicker-dial timepicker-hours"></div>', '<div class="timepicker-dial timepicker-minutes timepicker-dial-out"></div>', '</div>', '<div class="picker__footer">', '</div>', '</div>', '</div>', '</div>'].join('');
...
;(function ($) {
  ...
  var Carousel = function () {
    ...
    function Carousel(el, options) {
      ...
      this.$el.find('.carousel-item').each(function (el, i) {
        _this34.images.push(el);
        if (_this34.showIndicators) {
          var $indicator = $('<li class="indicator-item"></li>');
          ...
          _this34.$indicators.append($indicator);
        }
      });
      if (this.showIndicators) {
    ...
    _createClass(Carousel, [{
      ...
      value: function _setupEventHandlers() {
        ...
        if (this.showIndicators && this.$indicators) {
          ...
          this.$indicators.find('.indicator-item').each(function (el, i) {
            el.addEventListener('click', _this35._handleIndicatorClickBound);
          });
        }

        // Resize
        var throttledResize = Materialize.throttle(this._handleResize, 200);
        this._handleThrottledResizeBound = throttledResize.bind(this);
      ...
      value: function _removeEventHandlers() {
        ...
        if (this.showIndicators && this.$indicators) {
          this.$indicators.find('.indicator-item').each(function (el, i) {
            el.removeEventListener('click', _this36._handleIndicatorClickBound);
          });
        }
        ...
        if (firstImage.length) {
          if (firstImage[0].complete) {
            ...
            firstImage.one('load', function (el, i) {
              _this37.$el.css('height', el.offsetHeight + 'px');
            });
          }
        } else if (!imageOnly) {
      ...
      value: function _scroll(x) {
        ...
        this.scrollingTimeout = window.setTimeout(function () {
          _this38.$el.removeClass('scrolling');
        }, this.options.duration);
  ...
  jQuery.fn.carousel = function (methodOrOptions) {
    ...
    if (Carousel.prototype[methodOrOptions]) {
      ...
      // Getter methods
      if (methodOrOptions.slice(0, 3) === 'get') {
        var instance = this.first()[0].M_Carousel;
        return instance[methodOrOptions].apply(instance, params);

        // Void methods
      } else {
        return this.each(function () {
          var instance = this.M_Carousel;
          instance[methodOrOptions].apply(instance, params);
        });
      }
...
;(function ($) {
  ...
  var FeatureDiscovery = function () {
    ...
    _createClass(FeatureDiscovery, [{
      ...
      value: function _calculatePositioning() {
        ...
        var originTop = isFixed ? this.$origin.offset().top - Materialize.getDocumentScrollTop() : this.$origin.offset().top;
        var originLeft = isFixed ? this.$origin.offset().left - Materialize.getDocumentScrollLeft() : this.$origin.offset().left;
  ...
  jQuery.fn.featureDiscovery = function (methodOrOptions) {
    ...
    if (FeatureDiscovery.prototype[methodOrOptions]) {
      ...
      // Getter methods
      if (methodOrOptions.slice(0, 3) === 'get') {
        var instance = this.first()[0].M_FeatureDiscovery;
        return instance[methodOrOptions].apply(instance, params);

        // Void methods
      } else {
        return this.each(function () {
          var instance = this.M_FeatureDiscovery;
          instance[methodOrOptions].apply(instance, params);
        });
      }
...
;(function ($) {
    ...
    _createClass(Select, [{
      ...
      value: function _setupEventHandlers() {
        ...
        $(this.dropdownOptions).find('li:not(.optgroup)').each(function (el) {
          el.addEventListener('click', _this39._handleOptionClickBound);
        });
      ...
      value: function _removeEventHandlers() {
        ...
        $(this.dropdownOptions).find('li:not(.optgroup)').each(function (el) {
          el.removeEventListener('click', _this40._handleOptionClickBound);
        });
        ...
        if (this.$selectOptions.length) {
          this.$selectOptions.each(function (el) {
            if ($(el).is('option')) {
              ...
              var optionEl = void 0;
              if (_this41.isMultiple) {
                optionEl = _this41._appendOptionWithIcon(_this41.$el, el, 'multiple');
              } else {
                optionEl = _this41._appendOptionWithIcon(_this41.$el, el);
              }

              if ($(el).prop('selected')) {
                _this41.$selectedOptions.add(optionEl);
              }
            } else if ($(el).is('optgroup')) {
              // Optgroup.
              var selectOptions = $(el).children('option');
              $(_this41.dropdownOptions).append($('<li class="optgroup"><span>' + el.getAttribute('label') + '</span></li>')[0]);

              selectOptions.each(function (el) {
                var optionEl = _this41._appendOptionWithIcon(_this41.$el, el, 'optgroup-option');
                if ($(el).prop('selected')) {
                  _this41.$selectedOptions.add(optionEl);
                }
              });
      ...
      value: function _setSelectedStates() {
        ...
        this.$el.find('option').each(function (el, i) {
          ...
          if ($(el).prop('selected')) {
            ...
            _this42._activateOption($(_this42.dropdownOptions), option);
            _this42.valuesSelected.push(i);
          } else {
  ...
  jQuery.fn.select = function (methodOrOptions) {
    ...
    if (Select.prototype[methodOrOptions]) {
      ...
      // Getter methods
      if (methodOrOptions.slice(0, 3) === 'get') {
        var instance = this.first()[0].M_Select;
        return instance[methodOrOptions].apply(instance, params);

        // Void methods
      } else {
        return this.each(function () {
          var instance = this.M_Select;
          instance[methodOrOptions].apply(instance, params);
        });
      }
...
;(function ($, Vel) {
  ...
  jQuery.fn.range = function (methodOrOptions) {
    ...
    if (Range.prototype[methodOrOptions]) {
      ...
      // Getter methods
      if (methodOrOptions.slice(0, 3) === 'get') {
        var instance = this.first()[0].M_Range;
        return instance[methodOrOptions].apply(instance, params);

        // Void methods
      } else {
        return this.each(function () {
          var instance = this.M_Range;
          instance[methodOrOptions].apply(instance, params);
        });
      }
